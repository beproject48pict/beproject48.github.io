...
if(!isset($_SESSION['logged']) || $_SESSION['logged'] != true)
    ...
    if(isset($_GET['delete']))
    {
      include 'partials/_dbconnect.php';
        ...
        $sql = "DELETE FROM `signuptable` WHERE `signuptable`.`sr_no` = '$sno'";
      ...
      <?php
        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          <tr>
            ...
            <td>'.$row['email'].'</td>
            <td>
            <button class="delete btn btn-danger" id=d'.$row["sr_no"].' >Delete</button>
            </td>
            </tr>
            ';
        }
    ...
    <script>
        ...
        Array.from(deletes).forEach((element)=>{
          element.addEventListener("click", (e)=>{
            ...
            {
              console.log("yes");
              window.location = `/project2/admin.php?delete=${sno}`;
            }
            else{
              console.log("no");
            }
